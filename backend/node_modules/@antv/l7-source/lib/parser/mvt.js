...
var getVectorTile = async (url, tileParams, tile, requestParameters) => {
...
function mapboxVectorTile(data, cfg) {
  ...
  const getTileData = (tileParams, tile) => getVectorTile(url, tileParams, tile, cfg == null ? void 0 : cfg.requestParameters);
