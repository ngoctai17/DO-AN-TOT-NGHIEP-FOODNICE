...
const ProductDetail = ({ route }) => {
    ...
    const loadComment = () => {
        getData('user').then(user => {
            axios({
                method: 'GET',
                url: `http://192.168.0.69:3000/api/comment/get/${route.params._id}`,
                headers: { authorization: `Bearer ${user.access_token}` }
            })
                .then(res => {
    ...
    const addCart = () => {
        getData('user').then(user => {
            axios({
                method: 'POST',
                url: 'http://192.168.0.69:3000/api/cart/add',
                headers: {
    ...
    const addFavorite = () => {
        getData('user').then(user => {
            axios({
                method: 'POST',
                url: 'http://192.168.0.69:3000/api/favorite/add',
                headers: {
                    authorization: `Bearer ${user.access_token}`,
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
    ...
    const deleteFavorite = () => {
        getData('user').then(user => {
            axios({
                method: 'POST',
                url: `http://192.168.0.69:3000/api/favorite/delete/`,
                headers: {
                    authorization: `Bearer ${user.access_token}`,
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
